...
contract SupplyChain is DistributorRole, ConsumerRole{
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public 
  {
    ...
    items[sku]= Item({sku: sku,upc: _upc, ownerID: owner ,originFarmerID: _originFarmerID, originFarmName: _originFarmName, originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude, productNotes: _productNotes, productID: sku + upc, productPrice: 0 , distributorID: 0, retailerID:0 , consumerID:0, itemState:State.Harvested});
    emit Harvested(sku);
    // Increment sku
    sku = sku + 1;
  ...
  function receiveItem(uint _upc) shipped(_upc) onlyDistributor() public
    // Call modifier to check if upc has passed previous supply chain stage
